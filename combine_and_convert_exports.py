# Path: combine_and_convert_exports.py
# Written with the help of github copilot
# Steps:
# 1. Load all the JSON files from the folder /data/discord_chat_exports
...
# 4. Save the converted data to the file /data/converted.txt
#
# Requirements:
